...
Ici vous pouvez choisir deb.debian.org:
  ...
  - Il ne faut pas d'environnement de bureau vu que l'on veut installer Debian 12 comme serveur, décochez toutes les cases sauf serveur ssh et utilitaires usuels du système qui devront rester cocher car nous en avons besoin pour notre serveur.
